  ...
  return (
    ...
    >
      <div className="w-full max-w-6xl mx-auto flex flex-col space-y-16">
        ...
        >
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white mb-6">Expertise.</h2>
        ...
        >
          ...
          <motion.div 
            ...
            data-cursor="hover"
            className="group relative col-span-1 md:col-span-2 lg:col-span-2 overflow-hidden bg-white/[0.03] border border-white/10 rounded-3xl p-8 backdrop-blur-md transition-all duration-500 hover:-translate-y-2 hover:bg-white/[0.05] hover:shadow-[0_0_40px_-10px_rgba(34,211,238,0.15)]"
          >
            {/* Inner Hover Glow */}
            ...
            <div className="relative z-10 flex flex-col h-full justify-between gap-8">
              <div className="p-4 bg-white/5 w-max rounded-2xl border border-white/10 group-hover:border-cyan-500/30 transition-colors">
                <Code className="w-8 h-8 text-cyan-400" />
              </div>
              <div>
                <h3 className="text-2xl font-bold text-white mb-3">Web Development</h3>
                <p className="text-gray-400 text-lg">Architecting modern, scalable, and highly interactive frontends. Engineering performance and smooth UX using <span className="text-white font-medium">Next.js, React, and Tailwind CSS</span>.</p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div 
            variants={itemVariants}
            data-cursor="hover"
            className="group relative col-span-1 border overflow-hidden bg-white/[0.03] border-white/10 rounded-3xl p-8 backdrop-blur-md transition-all duration-500 hover:-translate-y-2 hover:bg-white/[0.05] hover:shadow-[0_0_40px_-10px_rgba(168,85,247,0.15)]"
          >
            ...
            <div className="relative z-10 flex flex-col h-full justify-between gap-8">
              <div className="p-4 bg-white/5 w-max rounded-2xl border border-white/10 group-hover:border-purple-500/30 transition-colors">
                <Database className="w-8 h-8 text-purple-400" />
              </div>
              <div>
                <h3 className="text-2xl font-bold text-white mb-3">Data Analysis & Machine Learning</h3>
                <p className="text-gray-400 text-lg">Extracting insights from complex data streams and implementing intelligent models.</p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div 
            variants={itemVariants}
            data-cursor="hover"
            className="group relative col-span-1 md:col-span-2 lg:col-span-3 overflow-hidden bg-white/[0.03] border border-white/10 rounded-3xl p-8 backdrop-blur-md transition-all duration-500 hover:-translate-y-2 hover:bg-white/[0.05] hover:shadow-[0_0_40px_-10px_rgba(236,72,153,0.15)]"
          >
            ...
            <div className="relative z-10 flex flex-col md:flex-row h-full justify-between items-start md:items-center gap-8">
              <div className="flex flex-col gap-8 flex-1">
                <div className="p-4 bg-white/5 w-max rounded-2xl border border-white/10 group-hover:border-pink-500/30 transition-colors">
                  <PenTool className="w-8 h-8 text-pink-400" />
                </div>
                <div className="max-w-2xl">
                  <h3 className="text-2xl font-bold text-white mb-3">UI UX Desainer</h3>
                  <p className="text-gray-400 text-lg">Crafting intuitive, user-centric interfaces. Balancing bold aesthetics (Flerdesign) and functional precision (Antigravity) to deliver highly engaging experiences.</p>
                </div>
              </div>
