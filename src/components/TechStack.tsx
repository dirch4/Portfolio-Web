...
const expertise = [
  ...
  },
  {
    ...
    tech: "Flutter, Dart",
    desc: "Focus on building cross-platform mobile applications. "
  },
  {
    title: "UI UX Design",
    tech: "Figma, Adobe XD",
    desc: "Focus on creating visually appealing and user-friendly interfaces."
  }
];
        ...
        {expertise.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`w-full md:w-1/2 flex ${isLeftCol ? 'md:justify-end md:pr-16' : 'hidden md:flex md:invisible'
                  } relative z-10`}
              >
                {isLeftCol && (
                  <motion.div
              ...
              <div
                className={`w-full md:w-1/2 flex ${!isLeftCol ? 'md:justify-start md:pl-16' : 'hidden md:flex md:invisible'
                  } relative z-10`}
              >
                {!isLeftCol && (
                  <motion.div
